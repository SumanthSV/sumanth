  ...
  const skillCategories = [
    {
      ...
      skills: ['React', 'TypeScript', 'Tailwind CSS', 'Next.js', 'i18next', 'JavaScript'],
    ...
    },
    {
      ...
      skills: ['Python', 'Node.js', 'Express.js', 'LLMs','Firebase', 'GCP'],
    ...
    },
    {
      ...
      skills: ['MySQL', 'MongoDB', 'Postman', 'Git', 'Github','Docker'],
